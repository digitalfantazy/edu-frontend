...
export const AppRouter = ({ isAuth }: RouterProps) => {
  ...
  return (
    <Routes>
      <Route path="/" element={<MainPage refProp={ref} scrollToCatalog={scrollToCatalog} />} />
...
//       <Header />
//       <Routes>
//         <Route exact path="/" element={<MainPage refProp={ref} scrollToCatalog={scrollToCatalog} />} />
//         <Route path="auth" element={<AuthPage />} />
//         <Route
//           path="auth/verify-email/:username"
//           element={
